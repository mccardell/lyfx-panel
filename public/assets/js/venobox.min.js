...
$(window).resize(function(){if($('.vbox-content').length){setTimeout(updateOL(),800)}})})}})})(jQuery);$(document).ready(function(){$('.venobox').venobox()})