...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu"><form method="GET" action="/panel/list/'+options+'">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button type="submit" class="applyBtn" disabled="disabled"></button>&nbsp;' +
                    '<button class="cancelBtn item-delete"></button>' +
                  '</div>' +
                '</div>' +
              '</form></div>';
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                this.container.css({
                    ...
                    //left: this.element.offset().left - 450,
                    right: 'auto'
                });
